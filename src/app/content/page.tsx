...
import { Sparkles, Wand2, Copy, History, Trash2, Save, Calendar } from "lucide-react"
    ...
    <div className="p-6">
      <div className="flex items-center justify-between mb-6">
        ...
        <Button variant="outline" onClick={() => setShowHistory(!showHistory)}>
          <History className="w-4 h-4 mr-1" /> 历史记录 ({history.length})
        </Button>
      </div>
            ...
            <CardContent className="py-4">
              ...
              {generatedText ? (
                <div className="space-y-4">
                  ...
                  />
                  <textarea
                    className="w-full min-h-[380px] rounded-lg border border-input bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 resize-y leading-relaxed"
                    placeholder="编辑正文..."
                    value={contentBody}
